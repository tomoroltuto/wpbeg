        ...
        <div class="c-grid">
            <div class="p-contents">
                <div class="post">
                    ...
                    <p>本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。本文の抜粋が入ります。<a
                            class="more-link" href="single.html">続きを読む</a></p>
                </div>
                <div class="post">
                    <h2 class="post__ttl"><a
                            href="single.html">長い記事のタイトル長い記事のタイトル長い記事のタイトル長い記事のタイトル長い記事のタイトル長い記事のタイトル長い記事のタイトル</a></h2>
                    <ul class="post__meta">
                        <li class="post__meta__item">
                            <date class="post__meta__date">2017年10月31日</date>
                        </li>
