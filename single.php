                    ...
                    while (have_posts()) :
                        ...
                        <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            ...
                            <ul class="post__meta">
                                ...
                                <li class="post__meta__item"><i class="fa fa-folder"
                                        aria-hidden="true"><?php the_category(', '); ?></i></li>
                                <li class="post__meta__item"><i class="fa fa-tag"
                                        aria-hidden="true"><?php the_tags(''); ?></i></li>
                            </ul>
